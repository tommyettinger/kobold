...
import com.github.tommyettinger.ide.contentassist.antlr.KoboldParser;
import com.github.tommyettinger.ide.contentassist.antlr.internal.InternalKoboldLexer;
import com.github.tommyettinger.idea.facet.KoboldFacetConfiguration;
import com.github.tommyettinger.idea.facet.KoboldFacetType;
import com.github.tommyettinger.idea.lang.KoboldElementTypeProvider;
import com.github.tommyettinger.idea.lang.parser.KoboldParserDefinition;
import com.github.tommyettinger.idea.lang.parser.KoboldPsiParser;
import com.github.tommyettinger.idea.lang.parser.KoboldTokenTypeProvider;
import com.github.tommyettinger.idea.lang.parser.antlr.KoboldAntlrTokenFileProvider;
import com.github.tommyettinger.idea.parser.antlr.internal.PsiInternalKoboldLexer;
...
/**
 * Manual modifications go to {@link KoboldIdeaModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractKoboldIdeaModule extends DefaultIdeaModule {
	...
	public Class<? extends Lexer> bindLexer() {
		return PsiInternalKoboldLexer.class;
	}
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.ide.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(Names.named(LexerIdeBindings.CONTENT_ASSIST)).to(InternalKoboldLexer.class);
	}
