 ...
 */
package com.github.tommyettinger.ide.contentassist.antlr;

import com.github.tommyettinger.ide.contentassist.antlr.internal.InternalKoboldParser;
...
public class KoboldParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalKoboldParser createParser() {
		InternalKoboldParser result = new InternalKoboldParser(null);
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalKoboldParser typedParser = (InternalKoboldParser) parser;
